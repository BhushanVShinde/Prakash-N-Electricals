...
const BrandCard = ({ brand, index = 0 }) => {
  return (
    <ScrollAnimation delay={index * 80} animation="scale">
      <article className="group bg-white rounded-2xl p-6 md:p-8 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 border border-gray-100 h-full flex flex-col items-center text-center">
        ...
        <h3 className="text-xl lg:text-2xl font-bold text-primary mb-3">{brand.name}</h3>
